...
excel_parking_slots_sections=r"C:\Users\Tablet\Documents\GitHub\Aparcamientos---py\plazas_seccion.xlsx"
excel_distance_between_sections=r"C:\Users\Tablet\Documents\GitHub\Aparcamientos---py\distancias.xls"
# logs
time_log_file=r"C:\Users\Tablet\Documents\GitHub\Aparcamientos---py\log_time.txt"
log_file=r"C:\Users\Tablet\Documents\GitHub\Aparcamientos---py\log.txt"
log_aimsun_file=r"C:\Users\Tablet\Documents\GitHub\Aparcamientos---py\logaimsun.log"
# carpeta resultados
results_export_path = r"E:\OneDrive - Universidad de Cantabria\Recordar GIST - VARIOS\Aparcamientos\resultados_temporales"
...
# para el modelo de distribución de tiempo de aparcamiento
avg_parking_duration = 60 * 60 #seconds
std_parking_duration = 60 * 60 #seconds

initial_ocupancy = 95 #%

# para el tiempo de búsqueda de la funcion de utilidad (no informados)
min_search_time = 2 #minutes
std_search_time = 4.87 #minutes
avg_search_time = 6.58 #minutes
min_search_time_parking= 1.54 #minutes

# para el tiempo de acceso a destino de la función de utilidad
walking_time_to_destination = 120 #seconds

# tarifas, en el caso de estáticas poner siempre la misma (mantener el formato de tupla)
