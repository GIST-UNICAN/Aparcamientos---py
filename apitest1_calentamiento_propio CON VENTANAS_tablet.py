...
ruta_excel = r"D:\Documentos\GitHub\Aparcamientos---py\plazas_seccion.xlsx"
ruta_excel_distancias = r"D:\Documentos\GitHub\Aparcamientos---py\distancias.xls"
centroides_objetivo = (
    34894,
    34892,
    34783,
...
def recibe_datos():
    ...
    script_python = "D:\\Documentos\\GitHub\\Aparcamientos-visualizacion---py\\rec37.py"
...
class Timer:
    ...
    def __exit__(self, *args):
        ...
        with open(r"D:\Documentos\GitHub\Aparcamientos---py\log_time.txt", 'a') as log:
            print(self.nombre, " tardo ", self.interval, "segundos.", file=log)


def imprime_texto(*txt):
    with open(r"D:\Documentos\GitHub\Aparcamientos---py\log.txt", 'a') as log:
        print(*txt, file=log)
...
# df_exportar.to_csv(path_or_buf=ruta_excel_exportar+fecha_hora_txt+r"informe.csv")
    ...
    df_consumos.to_excel(ruta_excel_exportar +
        ...
        engine="xlsxwriter")
    with open(r"D:\Documentos\GitHub\Aparcamientos---py\logaimsun.log", 'w') as file:
